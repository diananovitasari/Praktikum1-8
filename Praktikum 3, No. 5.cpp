...
//pake array
cout << "\n Pake Array :";
cout << "\n data yang anda masukan adalah "; //// hapus baris yang ini kalo gak mau nampilin lagi elemennya
max = min = data[0];
for(i=0; i<a; i++) {
cout << data[i] << ','; // hapus baris yang ini kalo gak mau nampilin lagi elemenya
sum = sum + data[i];
if (max < data[i]) {
max = data[i];
}
